...
<head>
    ...
    <link href="..//src//css//output.css" rel="stylesheet" type="text/css">
    <link href="..//src//css//style.css" rel="stylesheet" type="text/css">
    <link rel="shortcut icon" href="..//src/img/DIGESZA.png">
  ...
  <nav class="px-2 bg-blue-900 flex">
    <div class="container flex flex-wrap items-center justify-between mx-auto ctn-tablet">
      ...
      <a href="index.html" class="xl:ml-4 lg:ml-4 flex items-center hover:bg-slate-400 rounded"> 
          <img src="../src/img/DIGESZA.png" class="mr-3 sm:h-12"/>
...
<div class="flex-auto w-full mt-0.3 bg-blue-500 py-5">

  <div class="flex flex-wrap">

      <div class="xl:w-5/12 lg:w-6/12 mt-10 py-2 rounded-lg bg-black ml-3 mr-4 bg-opacity-60">
        <h4 class="text-2xl font-mono mx-2 uppercase text-white">
          Somos una <b class="underline decoration-sky-500 text-yellow-600">SOFOM</b> mandataria de <b><em class="underline 
          decoration-sky-500 text-yellow-600">FOVISSSTE</em></b> autorizada
          para la formalización de créditos hipotecarios, con presencia en 5 
          Estados de la República:
        </h4>
      </div>

      <div class="bg-yellow-400 xl:w-6/12 lg:w-5/12 mt-2 ml-10">
        imagen 
      </div>
...
<div class="flex-auto w-full mt-0.3 bg-white py-5">
  <div class="grid grid-cols-3 gap-6 mx-5 text-center">

    <div class="bg-green-400">GUERRERO</div>
    <div class="bg-green-500">TAMAULIPAS</div>
    <div class="bg-green-600">ESTADO DE MÉXICO</div>
    <div class="bg-green-700">CIUDAD DE MÉXICO (Hipródromo Condesa)</div>
    <div class="bg-green-800">CIUDAD DE MÉXICO (Del Valle del Sur)</div>
